...
XWAY IR 是一个开源、免费、持续迭代的蓝队工具。我们会**每 3-6 个月迭代一次**,基于公开应急手册和实战反馈持续扩展检测能力,尽可能覆盖更多入侵场景。

**你的支持能让我们**:
- 持续跟踪公开威胁情报,扩充 IOC 库
- 集成更多应急手册的检测点(像 v3.1 一样)
- 保持工具的零依赖、纯 Bash、单文件可部署特性
- 维护 CI、bats 测试、文档和 Issue 响应

<p align="center">
  <img src="docs/donate-qr.png" alt="赞赏码" width="280">
</p>

<p align="center">
  <b>扫码赞赏,助力持续迭代</b><br>
  <sub>金额随意,心意到即可。所有支持者名单会在后续版本致谢中列出(如不愿公开请备注)。</sub>
</p>

> 如果不方便赞赏,**点个 Star ⭐、转发给同行、提个 Issue 反馈实战问题**,同样是对我们最大的支持。
